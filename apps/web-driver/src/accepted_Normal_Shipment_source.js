export const userColumns = [
    ...
    // },
    {
      ...
      width: 180,
      valueGetter: (params) => params.row.shipment_id._id,
    },
    {
      field: "pickupAddress",
      headerName: "Pickup",
    ...
    },
    {
      ...
      width: 130,
      valueGetter: (params) => params.row.shipment_id.vehicleCategory,
    },
    {
      field: "vehiclePart",
      headerName: "Vehicle's Devision",
      width: 130,
      valueGetter: (params) => params.row.shipment_id.vehiclePart,
    },
    {
      field: "totalVolume",
      headerName: "Total Volume",
      width: 120,
      valueGetter: (params) => params.row.shipment_id.totalVolume,
    },
    {
      field: "status",
      headerName: "Status",
